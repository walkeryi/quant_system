...
from quant_system.charts import FenshiChartWidget

from quant_system.charts import FenshiVolumeChartWidget

from quant_system.charts import KlineChartWidget

from quant_system.stock.threads import FenshiDataThread

from quant_system.stock.threads import DailyDataThread

from quant_system.stock.threads import WeeklyDataThread

from quant_system.stock.threads import MonthlyDataThread

from quant_system.stock.threads import TradeThread
...
class StockTab(QWidget):
    ...
    def on_fenshi_ready(self, df):
        ...
        if not df.empty:
            ...
            snapshot = {
                ...
                'volume': float(df['minute_volume'].sum())
    ...
    def on_data_load_failed(self, error_msg):
        ...
        if hasattr(self, 'loading_text'):
            ...
            self.loading_text.set_text("数据拉取失败")
