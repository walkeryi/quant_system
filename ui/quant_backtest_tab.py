...
from ui.threads.optimizer_thread import OptimizerThread  # 导入新构建的并行优化引擎
...
class QuantBacktestTab(QWidget):
    ...
    def initCenterTab(self):
        ...
        # Tab 2: 源码编辑器
        source_group = QGroupBox("策略逻辑 (Python 代码)")
        ...
        source_layout.addWidget(self.lbl_desc)
        source_layout.addWidget(self.source_viewer)
        source_layout.addWidget(self.btn_save_code, alignment=Qt.AlignmentFlag.AlignRight)

        self.right_tabs.addTab(source_group, "💻 源码编辑器")
